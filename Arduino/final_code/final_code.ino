...
void Setup_MPU6050_DMP()
{
   ...
   if(devStatus == 0){
    ...
    //I don't know why PUSH is in interrupt
    Serial.println(F("Enabling interrupt detection (Arduino switch)..."));
...
{
  ///Conenect RESET Pins to the RESET pin of Arduino ICSP
