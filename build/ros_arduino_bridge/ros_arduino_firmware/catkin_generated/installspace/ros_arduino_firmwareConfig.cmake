...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gmgniap/test_robot/install/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gmgniap/test_robot/install/lib;/home/gmgniap/robot/devel/lib;/opt/ros/indigo/lib)
